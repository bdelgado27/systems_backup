...
handle_run: 
	# run a new process, where a1 specifies ROM number to load and execute
	add a0, a1, zero
	call run_new_program

handle_print:
	# debug message
	#la a0, print_debug
	#call print
	# print string to console, where a1 is a pointer to string to be printed
	add a0, a1, zero
	call print
